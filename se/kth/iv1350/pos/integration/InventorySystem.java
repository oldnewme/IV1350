...
public class InventorySystem {
	 ...
	 */
	public Item getItem(long itemIdentifier) throws ItemNotFoundException, DatabaseFailureException{
		...
		if(itemInInventory(itemIdentifier)) {
			for(Item item : itemRegistry) {
				if(sameIdentifier(item.getItemIdentifier(), itemIdentifier)) {
